...
Currently, I'm in the middle of my co-op term, working as a Junior IT Systems Administrator at a medium-sized non-profit. Working in IT was not my expectation prior to CST to be straight forward. However, it has turned out to be an incredibly eye-opening experience that has significantly shifted my career aspirations. It has opened up paths for me in devops and other areas of tech I never considered till now. For now, let's focus on my current experience in the CST program to keep this more concise.
